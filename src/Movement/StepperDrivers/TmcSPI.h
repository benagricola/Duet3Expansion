 ...
 *      Author: David
 *  Purpose:
 *      Unified SPI driver for TMC5160/TMC2240 stepper drivers
 */

#ifndef SRC_MOVEMENT_STEPPERDRIVERS_TMCSPI_H_
#define SRC_MOVEMENT_STEPPERDRIVERS_TMCSPI_H_
...
#endif /* SRC_MOVEMENT_STEPPERDRIVERS_TMCSPI_H_ */
