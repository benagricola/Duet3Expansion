...
#define TMCSPI_USES_SHARED_SPI		1
...
constexpr float MaximumMotorCurrent 		= 2500;

// Not required with TmcSPI Driver
//constexpr float MaximumStandstillCurrent 	= 1500;

constexpr uint32_t DefaultStandstillCurrentPercent = 75;

constexpr Pin GlobalTmcSPICSPin 	= GpioPin(5);
constexpr Pin GlobalTmcSPIEnablePin = GpioPin(0);
...
#if TMCSPI_USES_SHARED_SPI || SUPPORT_SPI_SENSORS
